...
import { Admin_Client_Group_ADD } from 'utils/adminUrl'
...
const NewOne = () => {
    ...
    const handleSubmit = async () => {
        await axios.post(Admin_Client_Group_ADD, newOne, {headers})
            .then(res => {
                successAlert()
                setErrors({name: ''})
            })
            ...
            <Col md = "6">
                <Portlet>
                    <Portlet.Header bordered>
                        <Portlet.Addon>
                            <h4>* New Client Group</h4>
                        </Portlet.Addon>
                    </Portlet.Header>
                    <Portlet.Body>
                        <Form.Group controlId="nameID">
                            <Form.Label>* Client Group Name</Form.Label>
