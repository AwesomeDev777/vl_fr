...
import View from 'components/admin/accounting/journalEntry/view'
...
ViewPage.pageTitle = 'Acounting / View Journal Entry'
ViewPage.activeLink = 'admin/accounting/journalEntry/'
